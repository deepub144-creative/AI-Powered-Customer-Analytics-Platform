...
const FAQ = [
  ...
  { keys: ['who', 'built', 'creator', 'deepu'], answer: "This platform was built by Deepu B — a BCA (Data Science) student, combining segmentation, churn prediction, and sales forecasting into one deployed system using FastAPI, React, Docker, and AWS." },
